...
import { authenticate, AuthenticatedRequest, comparePassword } from '../middleware/auth';
...
router.delete('/conversations/:conversationId', authenticate, async (req: AuthenticatedRequest, res: Response) => {
  try {
    const user = req.user!;
