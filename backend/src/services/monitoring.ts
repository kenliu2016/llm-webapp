...
async function storeMetrics(metrics: RequestMetrics) {
  try {
...
async function storeError(errorDetails: any) {
  try {
    await query(`
...
export class AnalyticsService {
  ...
  private static async getRequestMetrics(startDate: Date, endDate: Date) {
  ...
  private static async getErrorMetrics(startDate: Date, endDate: Date) {
