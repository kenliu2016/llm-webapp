...
export function initializeRedis(): Promise<boolean>;
export namespace sessionService {
    function storeSession(sessionToken: any, sessionData: any, expirationTime?: number): Promise<boolean>;
    function getSession(sessionToken: any): Promise<any>;
    function deleteSession(sessionToken: any): Promise<boolean>;
    function extendSession(sessionToken: any, expirationTime?: number): Promise<boolean>;
    function getUserSessions(userId: any): Promise<any[]>;
}
export namespace rateLimitService {
    function checkRateLimit(identifier: any, limit?: number, windowSize?: number): Promise<{
        allowed: boolean;
        limit: number;
        remaining: number;
        resetTime: number;
    ...
    function resetRateLimit(identifier: any): Promise<boolean>;
}
export namespace cacheService {
    ...
    function clearPattern(pattern: any): Promise<number>;
}
